...
- Refactor-Workflow-Learning: Bei offenen Fragen zur GUI/Logik zuerst in den lokalen Refactor-Artefakten nachsehen (`refactored/`, `refactored_steps.md`, `complete.md`) und diese als Referenz fuer die weitere Umsetzung nutzen.
