...
public final class UpgradeWorkbenchScreen extends HandledScreen<UpgradeWorkbenchScreenHandler> {
	private static final Identifier WORKBENCH_TEXTURE = Identifier.of(TetraFabricMod.MOD_ID, "textures/gui/workbench.png");
	private static final Identifier PLAYER_INVENTORY_TEXTURE = Identifier.of(TetraFabricMod.MOD_ID, "textures/gui/player-inventory.png");
